...
var _user$project$App$channelRow = function (channel) {
	return A2(
...
var _user$project$App$channelsTable = function (channels) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$App$channelRow, channels)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$App$socketServer = 'ws://phoenixchat.herokuapp.com/ws';
...
var _user$project$App$LeaveChannel = {ctor: 'LeaveChannel'};
var _user$project$App$JoinChannel = {ctor: 'JoinChannel'};
var _user$project$App$ReceiveChatMessage = function (a) {
	return {ctor: 'ReceiveChatMessage', _0: a};
};
var _user$project$App$initPhxSocket = A4(
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
	'new:msg',
	'rooms:lobby',
	_user$project$App$ReceiveChatMessage,
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$App$socketServer)));
var _user$project$App$initModel = A3(
		...
		switch (_p2.ctor) {
			...
			case 'JoinChannel':
				var channel = A2(
					...
					_elm_lang$core$Basics$always(
						_user$project$App$ShowLeftMessage('rooms:lobby')),
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
						_elm_lang$core$Basics$always(
							_user$project$App$ShowJoinedMessage('rooms:lobby')),
						A2(
							_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
							_user$project$App$userParams,
...
var _user$project$App$newMessageForm = function (model) {
	return A2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$App$JoinChannel),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$App$LeaveChannel),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$App$channelsTable(
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$App$newMessageForm(model),
								_1: {
									ctor: '::',
									_0: A2(
...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"App.Msg":{"args":[],"tags":{"SendMessage":[],"SetNewMessage":["String"],"LeaveChannel":[],"ShowLeftMessage":["String"],"ReceiveChatMessage":["Json.Encode.Value"],"JoinChannel":[],"PhoenixMsg":["Phoenix.Socket.Msg App.Msg"],"ShowJoinedMessage":["String"],"NoOp":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
